    ...
    return (
      <div className={styles.cards}>
        <Row>
          ...
          <Col lg={4} md={6} sm={12} className={styles.cardBolimlar}>
            <div>
              <img
                alt=" "
                src={
                  this.state.data !== null &&
                  this.state.data.m_h_oshxona !== null
          ...
          <Col lg={4} md={6} sm={12} className={styles.cardBolimlar}>
            <div>
              ...
              >
                ...
                <p>
                  {this.state.data !== null &&
                  this.state.data.m_h_sport_t !== null
          ...
          >
            <div>
              <img
                ...
                src={
                  this.state.data !== null &&
                  this.state.data.m_h_musiqa !== null
              ...
              >
                ...
                <p>
                  {this.state.data !== null &&
                  this.state.data.m_h_musiqa_t !== null
          ...
          <Col lg={4} md={6} sm={12} className={styles.cardBolimlar}>
            <div>
              <img
                ...
                src={
                  this.state.data !== null &&
                  this.state.data.m_h_axborot !== null
              ...
              >
                ...
                <p>
                  {this.state.data !== null &&
                  this.state.data.m_h_axborot_t !== null
          ...
          <Col lg={4} md={6} sm={12} className={styles.cardBolimlar}>
            <div>
              <img
                ...
                src={
                  this.state.data !== null &&
                  this.state.data.m_h_xavfsizlik !== null
              ...
              >
                ...
                <p>
                  {this.state.data !== null &&
                  this.state.data.m_h_xavfsizlik_t !== null
          ...
          >
            <div>
              <img
                ...
                src={
                  this.state.data !== null &&
                  this.state.data.m_h_tibbiyot !== null
              ...
              >
                ...
                <p>
                  {this.state.data !== null &&
                  this.state.data.m_h_tibbiyot_t !== null
